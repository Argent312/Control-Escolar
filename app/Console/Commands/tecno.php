...
class tecno extends Command
{
     ...
     * @var string
     */
    protected $signature = 'tecno:update';
     ...
     * @var string
     */
    protected $description = 'Actualiza las calificaciones de la materia de Tecnologia';
    ...
    /*Tecnologia-grado1*/
        ...
        where grado=1 and materias.clave='TEC1';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grado/informacion/Tecnologia/Tecno_Primero.json';
    ...
    /*Tecnologia-grado2*/
        ...
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where grado=2 and materias.clave='TEC2';";
        $aprobado2=0; 
        $reprobado2=0;
        ...
        $file2='public/Calificaciones-grado/informacion/Tecnologia/Tecno_Segundo.json';
        file_put_contents($file2,$json_string2);

    /*Tecnologia-grado3*/
        $query3="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where grado=3 and materias.clave='TEC3';";
        $aprobado3=0; 
        $reprobado3=0;
        ...
        $file3='public/Calificaciones-grado/informacion/Tecnologia/Tecno_Tercero.json';
    ...
    /**************************************Grupo A-1**********************************************/
        ...
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='TEC1' and grupo='A';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/Tecnologia/Tec_Primero_GrupoA.json';
        file_put_contents($file,$json_string);
 
    /***************************************Grupo B-1***************************************/
        $query5="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='TEC1' and grupo='B';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/Tecnologia/Tec_Primero_GrupoB.json';
        file_put_contents($file,$json_string);
 
    /************************************Grupo A-2*****************************************/
        $query6="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='TEC2' and grupo='A';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/Tecnologia/Tec_Segundo_GrupoA.json';
        file_put_contents($file,$json_string);
 
    /*********************************Grupo B-2***********************************************/
        $query7="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='TEC2' and grupo='B';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/Tecnologia/Tec_Segundo_GrupoB.json';
        file_put_contents($file,$json_string);
    ...
    /************************************Grupo A-3*****************************************/
        ...
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='TEC3' and grupo='A';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/Tecnologia/Tec_Tercero_GrupoA.json';
        file_put_contents($file,$json_string);
 
    /*********************************Grupo B-3***********************************************/
        $query9="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='TEC3' and grupo='B';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/Tecnologia/Tec_Tercero_GrupoB.json';
        file_put_contents($file,$json_string);
