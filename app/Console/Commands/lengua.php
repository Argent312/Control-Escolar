...
class lengua extends Command
{
     ...
     * @var string
     */
    protected $signature = 'lengua:update';
     ...
     * @var string
     */
    protected $description = 'Actualiza las calificaciones de la materia Lengua Materna';
    ...
    /*Lengua Materna-grado1*/
        ...
        where grado=1 and materias.clave='LM1';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grado/informacion/LenguaMaterna/Espanol_Primero.json';
        file_put_contents($file,$json_string);
        

    /*Lengua Materna-grado32*/ 
        $query2="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where grado=2 and materias.clave='LM2';";
        $aprobado2=0; 
        $reprobado2=0;
        ...
        $file2='public/Calificaciones-grado/informacion/LenguaMaterna/Espanol_Segundo.json';
        file_put_contents($file2,$json_string2);

    /*Lengua Materna-grado3*/ 
        $query3="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where grado=3 and materias.clave='LM3';";
        $aprobado3=0; 
        $reprobado3=0;
        ...
        $file3='public/Calificaciones-grado/informacion/LenguaMaterna/Espanol_Tercero.json';
        file_put_contents($file3,$json_string3);

    /**************************************Grupo A-1**********************************************/
        $query4="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='LM1' and grupo='A';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/LenguaMaterna/Espanol_Primero_GrupoA.json';
        file_put_contents($file,$json_string);

    /***************************************Grupo B-1***************************************/
        $query5="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='LM1' and grupo='B';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/LenguaMaterna/Espanol_Primero_GrupoB.json';
        file_put_contents($file,$json_string);

    /************************************Grupo A-2*****************************************/
        $query6="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='LM2' and grupo='A';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/LenguaMaterna/Espanol_Segundo_GrupoA.json';
        file_put_contents($file,$json_string);

    /*********************************Grupo B-2***********************************************/
        $query7="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='LM2' and grupo='B';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/LenguaMaterna/Espanol_Segundo_GrupoB.json';
        file_put_contents($file,$json_string);
    ...
    /************************************Grupo A-3*****************************************/
        ...
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='LM3' and grupo='A';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/LenguaMaterna/Espanol_Tercero_GrupoA.json';
        file_put_contents($file,$json_string);

    /*********************************Grupo B-3***********************************************/
        $query9="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='LM3' and grupo='B';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/LenguaMaterna/Espanol_Tercero_GrupoB.json';
        file_put_contents($file,$json_string);
