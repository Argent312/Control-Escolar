...
class edufisica extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'edufisica:update';
     ...
     * @var string
     */
    protected $description = 'Actualiza las calificaciones de la materia de Educación Fisica';
    ...
    /*EduFisica-grado1*/ 
        ...
        where grado=1 and materias.clave='EF';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grado/informacion/EduFisica/Edu_Primero.json';
    ...
    /*Ciencias-grado2*/ 
        ...
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where grado=2 and materias.clave='EF2';";
        $aprobado2=0; 
        $reprobado2=0;
        ...
        $file2='public/Calificaciones-grado/informacion/EduFisica/Edu_Segundo.json';
        file_put_contents($file2,$json_string2);

    /*Ciencias-grado3*/ 
        $query3="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where grado=3 and materias.clave='EF3';";
        $aprobado3=0; 
        $reprobado3=0;
        ...
        $file3='public/Calificaciones-grado/informacion/EduFisica/Edu_Tercero.json';
    ...
    /**************************************Grupo A-1**********************************************/
        ...
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='EF' and grupo='A';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/EduFisica/Edu_Primero_GrupoA.json';
        file_put_contents($file,$json_string);

    /***************************************Grupo B-1***************************************/
        $query5="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='EF' and grupo='B';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/EduFisica/Edu_Primero_GrupoB.json';
        file_put_contents($file,$json_string);

    /************************************Grupo A-2*****************************************/
        $query6="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='EF2' and grupo='A';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/EduFisica/Edu_Segundo_GrupoA.json';
        file_put_contents($file,$json_string);

    /*********************************Grupo B-2***********************************************/
        $query7="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='EF2' and grupo='B';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/EduFisica/Edu_Segundo_GrupoB.json';
        file_put_contents($file,$json_string);
    ...
    /************************************Grupo A-3*****************************************/
        ...
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='EF3' and grupo='A';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/EduFisica/Edu_Tercero_GrupoA.json';
        file_put_contents($file,$json_string);

    /*********************************Grupo B-3***********************************************/
        $query9="select calificacion as total from calificaciones 
        inner join materias on calificaciones.materias_idMaterias=materias.idMaterias
        where materias.clave='EF3' and grupo='B';";
        $aprobado=0; 
        $reprobado=0;
        ...
        $file='public/Calificaciones-grupo/informacion/EduFisica/Edu_Tercero_GrupoB.json';
        file_put_contents($file,$json_string);
    }
}
