...
<?php
	$data = file_get_contents("Calificaciones-grado/informacion/EduFisica/Edu_Primero.json");
	$arreglo = json_decode($data, true); 

	$data2 = file_get_contents("Calificaciones-grado/informacion/EduFisica/Edu_Segundo.json");
	$arreglo2 = json_decode($data2, true); 

	$data3 = file_get_contents("Calificaciones-grado/informacion/EduFisica/Edu_Tercero.json");
...
window.onload = function () {
	...
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		title:{
			text: "Educación Fisica I"
		},

		exportFileName: "EduFisica I",
		exportEnabled: true,
	...
	var chart2 = new CanvasJS.Chart("chartContainer2",
	{
		...
		title:{
			text: "Educación Fisica II"
		},

		exportFileName: "EduFisica II", 
		exportEnabled: true,
	...
	var chart3 = new CanvasJS.Chart("chartContainer3",
	{
		...
		title:{
			text: "Educación Fisica III"
		},

		exportFileName: "EduFisica III",  
		exportEnabled: true,
