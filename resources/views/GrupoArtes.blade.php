...
<?php
	$data = file_get_contents("Calificaciones-grupo/informacion/Artes/Artes_Primero_GrupoA.json");
	$arreglo = json_decode($data, true); 

	$data2 = file_get_contents("Calificaciones-grupo/informacion/Artes/Artes_Primero_GrupoB.json");
	$arreglo2 = json_decode($data2, true); 

    /*********************************************************************/
    $data3 = file_get_contents("Calificaciones-grupo/informacion/Artes/Artes_Segundo_GrupoA.json");
	$arreglo3 = json_decode($data3, true); 

    $data4 = file_get_contents("Calificaciones-grupo/informacion/Artes/Artes_Segundo_GrupoB.json");
	$arreglo4 = json_decode($data4, true); 

    /*********************************************************************/
    $data5 = file_get_contents("Calificaciones-grupo/informacion/Artes/Artes_Tercero_GrupoA.json");
	$arreglo5 = json_decode($data5, true); 

    $data6 = file_get_contents("Calificaciones-grupo/informacion/Artes/Artes_Tercero_GrupoB.json");
...
window.onload = function () {
	...
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		exportFileName: "Grupo A:Artes I",
		exportEnabled: true,
	...
	var chart2 = new CanvasJS.Chart("chartContainer2",
	{
		...
		exportFileName: "Grupo B:Artes I",
		exportEnabled: true,
	...
	var chart3 = new CanvasJS.Chart("chartContainer3",
	{
		...
		exportFileName: "Grupo A:Artes II",
		exportEnabled: true,
	...
	var chart4 = new CanvasJS.Chart("chartContainer4",
	{
		...
		exportFileName: "Grupo B:Artes II",
		exportEnabled: true,
	...
	var chart5 = new CanvasJS.Chart("chartContainer5",
	{
		...
		exportFileName: "Grupo A:Artes III",
		exportEnabled: true,
	...
	var chart6 = new CanvasJS.Chart("chartContainer6",
	{
		...
		exportFileName: "Grupo B:Artes III",
		exportEnabled: true,
