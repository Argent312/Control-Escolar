...
<?php
	$data = file_get_contents("Calificaciones-grado/informacion/Historia/His_Primero.json");
	$arreglo = json_decode($data, true); 

	$data2 = file_get_contents("Calificaciones-grado/informacion/Historia/His_Segundo.json");
	$arreglo2 = json_decode($data2, true); 

	$data3 = file_get_contents("Calificaciones-grado/informacion/Historia/His_Tercero.json");
...
window.onload = function () {
	...
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		exportFileName: "Primer año:Historia",
		exportEnabled: true,
	...
	var chart2 = new CanvasJS.Chart("chartContainer2",
	{
		...
		exportFileName: "Segundo año: Historia II", 
		exportEnabled: true,
	...
	var chart3 = new CanvasJS.Chart("chartContainer3",
	{
		...
		exportFileName: "Tercer Año: Historia III",  
		exportEnabled: true,
