...
<?php
	$data = file_get_contents("Calificaciones-grado/informacion/Geografia/Geo_Primero.json");
	$arreglo = json_decode($data, true); 

	$data2 = file_get_contents("Calificaciones-grado/informacion/Geografia/Geo_Segundo.json");
	$arreglo2 = json_decode($data2, true); 

	$data3 = file_get_contents("Calificaciones-grado/informacion/Geografia/Geo_Tercero.json");
