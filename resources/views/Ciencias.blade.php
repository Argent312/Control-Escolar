...
<?php
	$data = file_get_contents("Calificaciones-grado/informacion/Ciencias/Ciencias_Primero.json");
	$arreglo = json_decode($data, true); 

	$data2 = file_get_contents("Calificaciones-grado/informacion/Ciencias/Ciencias_Segundo.json");
	$arreglo2 = json_decode($data2, true); 

	$data3 = file_get_contents("Calificaciones-grado/informacion/Ciencias/Ciencias_Tercero.json");
...
window.onload = function () {
	...
	var chart = new CanvasJS.Chart("chartContainer",
	{
		...
		title:{
			text: "Ciencias Bilogía"
		},

		exportFileName: "Ciencias I",
		exportEnabled: true,
	...
	var chart2 = new CanvasJS.Chart("chartContainer2",
	{
		...
		title:{
			text: "Ciencias(Fiscia)"
		},

		exportFileName: "Ciencias II",  
		exportEnabled: true,
	...
	var chart3 = new CanvasJS.Chart("chartContainer3",
	{
		...
		title:{
			text: "Ciencias(Quimica)"
		},

		exportFileName: "Ciencias III",  
